...
| Need | Use |
|----|----|
| Display width, width-aware padding | [`stringi::stri_width()`](https://rdrr.io/pkg/stringi/man/stri_width.html), [`stringi::stri_pad()`](https://rdrr.io/pkg/stringi/man/stri_pad.html) — [`cjk_width()`](https://pursuitofdatascience.github.io/tidyckj/reference/cjk_width.md) and [`cjk_pad()`](https://pursuitofdatascience.github.io/tidyckj/reference/cjk_pad.md) wrap these |
