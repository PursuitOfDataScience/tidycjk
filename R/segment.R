...
#' dictionary, and its models are lighter than MeCab's or jieba's tuned ones.
#' It is the right starting point and not the last word.
#'
...
#' the same way under `"zh"`, `"ja"` or the session default.
#'
