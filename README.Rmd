...
Three verbs take `(data, column)` and return a tibble, so they drop into a
[dplyr](https://CRAN.R-project.org/package=dplyr) pipeline. Two of them
summarise a text column; `cjk_tokens()` is under Segmentation below.
